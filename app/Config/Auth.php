...
class Auth extends ShieldAuth
{
    ...
    public array $views = [
        ...
        'auth_identities'             => 'auth/action_email_2fa', // Exemplo, mantenha ou altere conforme a necessidade futura
        'magic-link-login'            => 'auth/magic_link_login',
        'magic-link-message'          => 'auth/magic_link_message',
        'email-2fa-show'              => 'auth/email_2fa_show',
        'email-2fa-verify'            => 'auth/email_2fa_verify',
        'email-activate-show'         => 'auth/email_activate_show',
        'email-activate-verify'       => 'auth/email_activate_verify',
    ];
